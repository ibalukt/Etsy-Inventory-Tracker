...
$crud = new crud();
    ...
    if (isset($_POST['is_submitted']))
    {
        ...
        echo"1<br/>";
        $query ="INSERT INTO OffSite (ReasonID,IconID,GoingWhere) VALUES(?,?,?)";
        $params = array($ReasonID,$IconID,$GoingWhere);

        $crud->prep_execute($query,"iis",$params);
        echo "2<br/>";
        ...
        {          
            ...
            $params = array($ItemID);
            $item = $crud->prep_getData($query,"i",$params);
